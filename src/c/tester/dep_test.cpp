...
int main(void)
{
	nc_file_dep_generate("D:\\Emmm_HAck3r5\\NCM_project\\src");
	//nc_file_dep_generate("D:\\Emmm_HAck3r5\\NCMTester");
	
	/*EH_Array *a = eh_array_init(16);
	NC_File *file = nc_file_init();
	nc_read_file(file, "D:\\Emmm_HAck3r5\\NodeCodeMap\\src\\c\\tester\\tested.c");
	nc_lex_init();
